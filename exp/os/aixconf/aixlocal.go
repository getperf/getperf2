...
func (e *AIX) RunLocalCommand(ctx context.Context, metric *Metric) error {
...
func (e *AIX) RunLocalServer(ctx context.Context, env *cfg.RunEnv, server string) error {
	if runtime.GOOS != "AIX" {
		return fmt.Errorf("AIX environment only")
	}
